...
@section('title', 'Add Wallet Offer')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h2 class="mb-0">Add Wallet Offer</h2>
            ...
            <form action="{{ route('admin.wallet-offers.store') }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" min="0" max="100" class="form-control @error('extra_percent') is-invalid @enderror" id="extra_percent" name="extra_percent" value="{{ old('extra_percent') }}" required>
                        @error('extra_percent')<div class="invalid-feedback">{{ $message }}</div>@enderror
                    </div>
                    <div class="col-md-4 mb-3">
                        <label for="label" class="form-label">Label/Tag</label>
                        <input type="text" class="form-control @error('label') is-invalid @enderror" id="label" name="label" value="{{ old('label') }}" placeholder="e.g. Most Popular">
